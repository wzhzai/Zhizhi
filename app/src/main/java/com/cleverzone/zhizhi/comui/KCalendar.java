...
public class KCalendar extends ViewFlipper {
    ...
    private void init() {
        ...
        push_left_in.setDuration(ANIM_DURATION);
        push_left_out.setDuration(ANIM_DURATION);
        push_right_in.setDuration(ANIM_DURATION);
        push_right_out.setDuration(ANIM_DURATION);
        // 初始化第一个日历
        firstCalendar = new LinearLayout(getContext());
        firstCalendar.setOrientation(LinearLayout.VERTICAL);
        firstCalendar.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        // 初始化第二个日历
        secondCalendar = new LinearLayout(getContext());
        secondCalendar.setOrientation(LinearLayout.VERTICAL);
        secondCalendar.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        // 设置默认日历为第一个日历
