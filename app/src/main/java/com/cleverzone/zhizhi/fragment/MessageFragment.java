...
public class MessageFragment extends BaseFragment {
    ...
    private int[] mGroupImageResIds = {R.mipmap.icon_message_zz, R.mipmap.icon_message_little_tips, R.mipmap.icon_message_tasks};
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mGroupStrings = mContext.getResources().getStringArray(R.array.message_group_text);
        ExpandableListView expandableListView = (ExpandableListView) view.findViewById(R.id.message_exp_list);
        expandableListView.setAdapter(new MessageAdapter());
    }
